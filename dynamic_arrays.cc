...
public:
   ...
   */
  ~DynamicArray() { delete[] this->memory; }
   ...
   * @throws std::out_of_range If the index is less than 0 or greater than/equal
   * to size.
   */
  T get(int index) {
   ...
   */
  int get_size() { return static_cast<int>(this->size); }
   ...
   */
  int get_capacity() { return static_cast<int>(this->capacity); }
};
